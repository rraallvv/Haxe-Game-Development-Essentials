...
class LevelEndScreen extends FlxState
{
	...
	public function new(score:Int) 
	{
		...
		SoundManager.instance.playFanfareMusic();//NEW CH5
		SoundManager.instance.playWhooshSound(1);//CH5
	}
	...
	private function onHeaderAnimateIn(tween:FlxTween):Void{
		...
		SoundManager.instance.playTingSound();//NEW CH5
	}
	...
	private function onPlayAgain():Void {
		FlxG.camera.fade(FlxColor.BLACK,0.5, false,function() {//NEW CH5
			FlxG.resetState();
		});//NEW CH5
		SoundManager.instance.playClickSound();//NEW CH5
	}
