...
class PlayState extends FlxState
{
	...
	private var enemyLayer:EnemySpawner; //CH6 changed
	//private var numEnemies:Int = 20; //CH6 removed
	...
	override public function create():Void
	{
		super.create();
			...
			enemyLayer = new EnemySpawner();//CH6
			add(enemyLayer);
	...
	private function onProjectileCollision(projectile:FlxObject,enemy:FlxObject):Void {
		...
		if(enemy.x < (FlxG.width - 10) && Std.is(enemy, Enemy)){
