...
class GameHUD extends FlxGroup
{
	...
	public function new() 
	{
		...
		txtHealthHeader.text = Strings.instance.getValue(StringIDs.HEALTH);//CH6 "HEALTH:"; 
		txtHealthHeader.setFormat(AssetPaths.BebasNeue__otf, 36, FlxColor.WHITE, "left");
		add(txtHealthHeader);
		
		txtScore = new FlxText(62, 52, 500); 
		txtScore.text = Strings.instance.getValue(StringIDs.SCORE) +  0;//CH6 "SCORE: " + 0;
	...
	public function setScore(score:Int):Void{
		txtScore.text = Strings.instance.getValue(StringIDs.SCORE)+ score;//CH6 "SCORE: " + score;
	}
